		...
		<div className='flex grid grid-cols-1 md:grid-cols-2 my-2'>
			...
			<div className='flex flex-col justify-center'>
				...
				<Label className='text-center md:text-start text-2xl py-2'>
					I am a software developer with a passion to build great
					products. Open to discuss anything tech related.
				</Label>

				<a
					className='mx-auto md:mx-0 md:mr-auto my-4 bg-black gap-2 transition ease-in-out duration-500 text-white hover:bg-white hover:text-black border flex p-2 rounded'
					href='#schedule-meet'
				>
					Discuss over call
					<ArrowRight />
